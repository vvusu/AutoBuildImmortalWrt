...
# 仓库内代理相关apk（为避免 DNS/透明代理冲突，仅保留 OpenClash）
...
# 中兴 F50：USB RNDIS/CDC 共享网络（作为 WAN）
CUSTOM_PACKAGES="$CUSTOM_PACKAGES kmod-usb-net-rndis kmod-usb-net-cdc-ether kmod-usb-net-cdc-ncm usb-modeswitch usbutils"
# VPN
